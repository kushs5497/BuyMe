...
if (checkIfUserIsCustomerRepResults.next()) {
    out.println("<div class='container header'><h1><a href='CustomerRepHomePage.jsp'>BuyMe</a></h1></div>");
} else {
    out.println("<div class='container header'><h1><a href='LoginSuccess.jsp'>BuyMe</a></h1></div>");
}
